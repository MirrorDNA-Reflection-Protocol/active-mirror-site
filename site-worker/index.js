...
<html lang="en">
  <head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self'; base-uri 'self'; object-src 'none'; form-action 'self'; script-src 'self' https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https://gateway.activemirror.ai; connect-src 'self' https://gateway.activemirror.ai https://cloudflareinsights.com https://static.cloudflareinsights.com; font-src 'self' data:; media-src 'self' blob: data:; worker-src 'self' blob:; manifest-src 'self'; upgrade-insecure-requests" />
    ...
    <link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Crect width='64' height='64' rx='16' fill='%23000000'/%3E%3Cpath d='M32 10 50 20.5v21L32 54 14 41.5v-21L32 10Z' fill='none' stroke='%23a78bfa' stroke-width='4'/%3E%3Cpath d='M32 21 42 27v10L32 43 22 37V27L32 21Z' fill='none' stroke='%2322d3ee' stroke-width='4'/%3E%3C/svg%3E" />
    <title>Active Mirror - start with one thing</title>
    <script type="module" crossorigin src="/app/assets/index-BSdt2aCk.js"></script>
    <link rel="stylesheet" crossorigin href="/app/assets/index-Dco8iA2R.css">
  </head>
  <body>
    <div id="root"></div>
  </body>
